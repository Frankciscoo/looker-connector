...
if not client_id or not client_secret:
    ...
    def gather_filters_and_values():
        global all_filter
        num_filters = st.number_input("Enter the number of filters to be applied to all Looks (This filter will be applied to all Looks unless they are marked as 'Exclude from filters'):")
